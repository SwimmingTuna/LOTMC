...
public class DimensionInit {
    ...
    public static final ResourceKey<LevelStem> CONCEALED_SPACE_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            new ResourceLocation(LOTM.MOD_ID, "concealed_space"));
    public static final ResourceKey<Level> CONCEALED_SPACE_LEVEL_KEY = ResourceKey.create(Registries.DIMENSION,
            new ResourceLocation(LOTM.MOD_ID, "concealed_space"));
