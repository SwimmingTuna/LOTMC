...
public class PlayerTrailParticle extends TextureSheetParticle {
    public PlayerTrailParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
