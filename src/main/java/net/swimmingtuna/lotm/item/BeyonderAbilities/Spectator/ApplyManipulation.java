...
public class ApplyManipulation extends LeftClickHandlerSkillP {
    ...
    public <T> LeftClickType getleftClickEmpty(T item) {
        return new UpdateItemInHandC2S((Integer) item, new ItemStack(ItemInit.MANIPULATE_EMOTION.get()));
    }
}