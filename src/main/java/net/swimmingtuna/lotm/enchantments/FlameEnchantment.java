...
public class FlameEnchantment extends Enchantment {
    public FlameEnchantment(Rarity pRarity, EnchantmentCategory pCategory, EquipmentSlot... pApplicableSlots) {
    ...
    public Component getFullname(int level) {
        return Component.translatable("enchantment.lotm.flame");
    }
