...
public class FreezeEnchantment extends Enchantment {
    public FreezeEnchantment(Rarity pRarity, EnchantmentCategory pCategory, EquipmentSlot... pApplicableSlots) {
    ...
    public Component getFullname(int level) {
        return Component.translatable("enchantment.lotm.freeze");
    }
