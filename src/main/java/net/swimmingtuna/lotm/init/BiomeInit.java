...
public class BiomeInit {
    ...
    public static final DeferredRegister<Biome> BIOMES =
            DeferredRegister.create(ForgeRegistries.BIOMES, LOTM.MOD_ID);
    ...
    public static Biome frozenLandscape(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityInit.PLAYER_MOB_ENTITY.get(), 2, 3, 5));
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        ...
                        .backgroundMusic(Musics.createGameMusic(SoundEvents.MUSIC_BIOME_SNOWY_SLOPES)).build())
                .build();
    }
