...
import net.swimmingtuna.lotm.armor.Renderers.DawnArmorRenderer;
...
public class DawnArmorItem extends ArmorItem implements GeoItem {
    ...
    public DawnArmorItem(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    private PlayState predicate(AnimationState<DawnArmorItem> state){
